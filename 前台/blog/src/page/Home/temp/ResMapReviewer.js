...
class ResMapReviewer extends Component {
    constructor(props) {
        super(props);
        this.state = {
           loading: true,
    ...
    initMapDidMount(){
        let phyData = this.state.phyData;
        ...
        const option = {
            ...
            series: [{ 
                name: '登录用户数量',      // series名称
                type: 'effectScatter',        // series图表类型
                effectType: 'ripple',         // 圆点闪烁样式，目前只支持ripple波纹式
                coordinateSystem: 'geo',      // series坐标系类型
                data:  convertData(phyData),    // series数据内容
